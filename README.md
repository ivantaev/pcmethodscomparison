...
The visualization script (ultimate_comparison_pcmeth.py) uses functions from PF_analysis_visualization.py and data_handler.py to perform the data ordering; figure_maker.py builds figures. It requires .mat files, produced by the analysis script, to produce figures from Ivantaev et.al.
