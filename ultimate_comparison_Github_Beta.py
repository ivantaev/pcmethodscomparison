...
pc_method = ['Poisson'] #Brandon Poisson
#%%
...
compare_snr_newest(Snr, Mouse, days)
compare_si_newest(PF['Poisson'], PC_index['Poisson'], non_PC_index['Poisson'], All_cells['Poisson'])
visualize_pf_cm_sampling(PF['Poisson'], PC_index['Poisson'])
...
#%%
compare_rate_size(PF_pooled['Poisson'], PC_pooled['Poisson'], non_PC_pooled['Poisson'], Xytsp_pooled['Poisson'], XYT, 
                  Cell_count['Poisson'], savefig=False)
compute_PF_shifts(PF_pooled, PC_pooled, non_PC_pooled, cell_ind_pooled,saveex=False)

#%% compute & visualize correlations
#for method in pc_method:
compare_correlations(PF_pooled['Poisson'], PC_pooled['Poisson'], cell_ind_pooled['Poisson'], 'pfcorr', plot_ex = False)
compare_correlations(PF_pooled['Poisson'], PC_pooled['Poisson'], cell_ind_pooled['Poisson'], 'popveccorr')
